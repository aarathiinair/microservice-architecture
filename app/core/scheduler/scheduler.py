...
class CronJobScheduler:
    ...
    def outlook_job(self):
        ...
        try:
            ...
            #last_run =  datetime.now() - timedelta(hours=28)
        ...
        for msg in messages:
            try:
                ...
                latest_config = (
                    ...
                    .first())
                db.close()
                # print("SMTP Address:", smtp_address)
                sender_mailid = latest_config.outlook_email.split(',')[0]
                #print(sender_mailid)
                #if str(msg.Subject)!="ControlUp alert mail - Machine Down -  Machine DEROT01060.bitzer-bak.biz is down (Machine shut down gracefully.)":
                    #continue
                if smtp_address==sender_mailid or smtp_address == "monitoring.ai@bitzer.dez":
    ...
    def get_status(self) -> dict:
        ...
        return {
            ...
            "next_run": None if not self.scheduler.running else str(self.scheduler.get_job('email_processor').next_run_time),
