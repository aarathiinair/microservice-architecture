...
def main():
    """Example usage of the Email Rules Engine"""
   
    # Initialize the rules engine
    engine = EmailRulesEngine()
   
    # Test cases based on the spreadsheet data
    test_emails = [
        {
            "subject": "ControlUp alert mail - Advanced Trigger -  Logical Disk: C:\ on Computer: DESDN04199.bitzer.biz.",
            "body": "Trigger name: CITRIX Machines: Less 5GB AND less 10 Percent",
            "sender": "alerts@controlup.com",
            "timestamp": "2024-09-15T10:30:00Z"
        },
        {
            "subject": "ControlUp alert mail - Advanced Trigger -  Machine DEROT02010.bitzer.biz",
            "body": "Trigger name: CITRIX Machines: Disk Queue greater than or equal 1",
            "sender": "monitoring@citrix.com",
            "timestamp": "2024-09-15T11:45:00Z"
        },
        {
            "subject": "ControlUp alert mail - Machine Down -  Machine DESDN01058.bitzer.biz is down (Machine shut down gracefully.)",
            "body": "Trigger name: CITRIX Infrastructur Machines Computer Down Infrastructure",
            "sender": "monitoring@citrix.com",
            "timestamp": "2024-09-15T13:00:00Z"
        }
    ]
   
    print("KPMG Email Rules Engine - Test Results")
    print("=" * 50)
    ...
    for i, email in enumerate(test_emails, 1):
        ...
        print(f"Create JIRA: {result['create_jira']}")
        print(f"Category: {result['category']}")
        print(f"Machine: {result['machine_name']}")
       
        if result['create_jira']:
            print(f"JIRA Summary: {result['jira_ticket']['summary']}")
